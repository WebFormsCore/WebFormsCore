...
#pragma warning disable IL2066 // Type passed to generic parameter 'T' of 'WebFormsCore.ViewStateReader.Read<T>(T)' can not be statically determined and may not meet 'DynamicallyAccessedMembersAttribute' requirements.
