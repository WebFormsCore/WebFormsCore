...
public partial class Control
{
    ...
    protected IServiceProvider ServiceProvider => Context.RequestServices;
    ...
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [WebSysDescription("Control_Form")]
    ...
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    protected virtual IHttpContext Context => _page?.Context ?? HttpContextAccessor.Current ?? throw new InvalidOperationException("HttpContext is not available");
