...
#pragma warning restore CS8765
    ...
    public static HtmlTextWriterStyle GetStyleKey(string styleName)
    {
        ...
        {
            var key = AttrKeyLookupTable[styleName.ToLower(CultureInfo.InvariantCulture)];
            if (key != null)
            {
    ...
    /// </devdoc>
    internal static void RegisterAttribute(string name, HtmlTextWriterStyle key, bool encode = false, bool isUrl = false)
    {
    ...
    /// </devdoc>
    private readonly record struct AttributeInformation(string Name, bool IsUrl, bool Encode);
}
